<?php
/**
 * Template name: Portfolio Page 4-col.
 *
 * @package redshift
 */
...
<div class="row">
    ...
    <div class="portfolio-items" style="position: relative; overflow: show; height: 440px;">
      ...
      <div class="portfolio-item <?php echo $cat_slugs; ?> col-xs-12 col-sm-6 col-md-3">
      ...
      <a rel="magnific" href="<?php echo $image[0]; ?>" class="preview"><div class="team team-search" style="font-size:25px;"></div></a>
