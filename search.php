...
<div style="height:100px; width:100%; z-index: 1000; background-color:#f4543c; position:relative; top:0; text-align:center; margin-top: 20px; border-bottom:"><h5 class="page-title">Search</h5>
...
<div class="col-md-12 col-xs-12 col-sm-12">
	...
	<?php if ( have_posts() ) : ?>
		...
		<header>
			<h2 class="page-title"><?php printf( __( 'Search Results for: %s', 'redshift' ), '<span>' . get_search_query() . '</span>' ); ?></h2>
		</header> <!-- .page-header -->
